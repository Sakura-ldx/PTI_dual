...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--content", type=str, default='./data/content/birth.jpg', help="path of the content image")
...
if __name__ == "__main__":
    ...
    pti = PTI(encoder.decoder, device)
    ...
    with torch.no_grad():
        ...
        instyle, result_images = pti(instyle, I, True)
        instyle = instyle[0]
